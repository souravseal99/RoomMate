...
export function AuthForm({ mode, onSubmit }: Readonly<AuthFormInputData>) {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center p-4 md:p-6 bg-gradient-to-br from-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-10 right-10 w-40 h-40 bg-indigo-400/20 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: '1s' }}
      ></div>
      <div
        className="absolute top-1/3 right-20 w-24 h-24 bg-purple-400/10 rounded-full blur-2xl animate-pulse"
        style={{ animationDelay: '2s' }}
      ></div>
      <div
        className="absolute top-1/2 left-1/4 w-20 h-20 bg-blue-300/10 rounded-full blur-2xl animate-pulse"
      ...
      <div className="absolute top-8 left-8 hidden lg:block animate-in fade-in slide-in-from-left-5 duration-700">
        <div className="flex items-center gap-3 text-blue-600 hover:scale-105 transition-transform duration-300">
          <div
            className="w-12 h-12 rounded-xl bg-white/60 backdrop-blur-sm flex items-center justify-center shadow-lg animate-bounce"
      ...
      <div className="absolute bottom-8 left-8 hidden lg:flex flex-col gap-3 max-w-xs">
        <div
          className="bg-white/60 backdrop-blur-sm rounded-lg p-4 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 animate-in fade-in slide-in-from-left-5 duration-700"
        ...
        >
          <div className="flex items-start gap-3">
            <div
              className="w-2 h-2 bg-indigo-600 rounded-full mt-2 shrink-0 animate-pulse"
      ...
      <div
        className="absolute top-1/4 left-1/3 w-16 h-16 border-2 border-blue-300/30 rounded-lg rotate-45 animate-spin"
        style={{ animationDuration: '20s' }}
      ></div>
      <div
        className="absolute bottom-1/4 right-1/3 w-12 h-12 border-2 border-indigo-300/30 rounded-full animate-ping"
        style={{ animationDuration: '3s' }}
      ></div>
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="mb-6 text-center lg:hidden animate-in fade-in zoom-in duration-500">
          <div
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 shadow-2xl hover:scale-110 transition-transform duration-300"
            style={{ boxShadow: '0 20px 60px -15px rgba(59, 130, 246, 0.5)' }}
          >
            <Home className="w-8 h-8 text-white" />
          </div>
          <h1 className="mt-3 text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">
            RoomMate
          </h1>
        </div>
