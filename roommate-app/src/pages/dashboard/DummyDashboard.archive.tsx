...
function ArchivedDummyDashboard() {
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Welcome back! Here's what's happening in your households
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="p-5 flex items-center gap-4">
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${feature.bgGradient} flex items-center justify-center group-hover:scale-110 transition-transform`}
                    >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                {expense.paidBy} • {expense.household}
                              </p>
                            </div>
                          </div>
                    ...
                    <div className="divide-y divide-gray-100">
                      {stats.recentChores.map((chore) => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div
                              className={`w-10 h-10 rounded-full ${chore.status === 'COMPLETED' ? 'bg-green-50' : 'bg-orange-50'} flex items-center justify-center`}
                            >
                              <CheckSquare
                                className={`w-5 h-5 ${chore.status === 'COMPLETED' ? 'text-green-600' : 'text-orange-600'}`}
                              />
                            </div>
                            <div>
                              <p className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                              ...
                              <p className="text-xs text-gray-500">
                                {chore.assignee} • {chore.household}
                              </p>
                            </div>
                          </div>
                          <div className="text-right">
                            <span
                              className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${chore.status === 'COMPLETED' ? 'bg-green-100 text-green-700' : 'bg-orange-100 text-orange-700'}`}
                            >
                              {chore.status}
                            </span>
...
export default ArchivedDummyDashboard;
